...
class InstitutionIntegrationTest(PmPortalTestCase):
    ...
    def test_ct_institution_transition_apply_to_children(self):
        ...
        agenda_folder = api.content.create(
            type="Folder", title="Agenda", container=institution
        )
    ...
    def test_ct_institution_modified(self):
        ...
        self.portal.portal_setup.runAllImportStepsFromProfile(
            "profile-plonemeeting.portal.core:demo"
        )
        institution = api.content.create(
            container=self.portal, type="Institution", id="institution"
        )
        ...
        global_categories = get_registry_record(
        ...
        self.assertEqual(
            len(institution.categories_mappings), len(institution.delib_categories)
        )
        self.assertListEqual(
