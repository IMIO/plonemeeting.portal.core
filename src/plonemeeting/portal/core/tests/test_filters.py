...
class TestOutputFilters(PmPortalDemoFunctionalTestCase):
    ...
    def test_replace_masked_gdpr(self):
        ...
        set_registry_record(
            "plonemeeting.portal.core.rgpd_masked_text_redirect_path", "/toto"
        )
        self.assertEqual(
            filter(self.richtext),
            u"<p><strong>Article 1er</strong> :</p>"
        ...
        set_registry_record(
            "plonemeeting.portal.core.rgpd_masked_text_placeholder", "XXXXXXX"
        )
        self.assertEqual(
            filter(self.richtext),
            u"<p><strong>Article 1er</strong> :</p>"
    ...
    def test_replace_masked_gdpr_applies_on_items_only(self):
        ...
        result = (
            u"<p><strong>Article 1er</strong> :</p><p>Au scrutin secret et à l’unanimité, de désigner "
            u'<a class="pm-anonymize" href="http://nohost/plone/faq/rgpd"><span>TEXTE MASQUÉ | RGPD</span></a>, '
            u"en qualité d’instituteur maternel temporaire mi-temps en remplacement de "
            u'<a class="pm-anonymize" href="http://nohost/plone/faq/rgpd"><span>TEXTE MASQUÉ | RGPD</span></a> '
            u"aux écoles communales fondamentales.</p>"
        ...
        self.assertNotEqual(
            self.item.decision.output_relative_to(self.amityville), result
        )
